...
const testMw = () => {
  ...
  router.get('/context', (req, res) => {
    res.json({
      ...
      accessToken: {
        access_token: req.oidc.accessToken && req.oidc.accessToken.access_token,
        token_type: req.oidc.accessToken && req.oidc.accessToken.token_type,
        expires_in: req.oidc.accessToken && req.oidc.accessToken.expires_in,
        isExpired: req.oidc.accessToken && req.oidc.accessToken.isExpired(),
      },
